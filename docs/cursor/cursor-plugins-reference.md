...
> **Sections:** Plugin structure, Plugin manifest, Component discovery, Rules, Skills, Agents, Commands, Hooks, MCP servers, Logos, Multi-plugin repositories, Submitting a plugin
...
12. [Submitting a Plugin](#submitting-a-plugin)
...
*This summary was automatically generated from https://cursor.com/docs/reference/plugins*
