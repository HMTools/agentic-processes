...
3. **Read Memory File**
   - Read `core/processes/active/{process-folder}/memory.md` to retrieve stored information
...
Type `/process-continue` in Cursor's chat to resume an active process. If multiple processes exist, the AI will list them for you to choose from.
