...
1. **Check for Existing Processes**
   - Check if a similar process already exists in `core/processes/active/`
   - If found, inform you and ask if you want to resume or create new

2. **List Available Templates**
   - Display all available templates from `core/processes/templates/` (including `create-process-template` if it exists)
...
Type `/process-new` in Cursor's chat to start creating a new process. The AI will guide you through template selection and parameter collection.
...
The AI will help you choose the right template based on your needs. Available templates are in `core/processes/templates/`.
...
3. **log.md**: Log file initialized with:
   - Template structure from `core/processes/templates/log-template.md`
