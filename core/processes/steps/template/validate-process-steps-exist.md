...
Purpose: Analyze a template to identify which process-steps are referenced and verify they exist in core/processes/steps/
-->
...
- Check if each required process-step exists in `core/processes/steps/{category}/{step-name}.md`
...
**Files/Folders:**
- Review: `core/processes/templates/{{templateName}}.md` (the template being validated)
- Check: `core/processes/steps/{category}/{step-name}.md` for each referenced step
