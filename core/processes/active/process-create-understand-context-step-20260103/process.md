# Process: Create understand-context Step

**Template**: create-process-step-template
**Status**: Running

## Current State
**Active Step**: Step 4: Continuous Improvement & Learning
**Current Action**: Ready to begin
**Details**: Step 3 validation complete - all checks passed. Step file is ready for use.

## Description
Create a new process step file named understand-context in the planning category that Fully understand the context, sources, and requirements for a task or process. Clarify what needs to be accomplished, identify relevant information sources, understand success criteria, and document any specific requirements or constraints. Gather all necessary context to proceed with the work.. This step will be used when When you need to understand the context, sources, and requirements for a task or process before proceeding with the work. This step is used at the beginning of processes to establish a clear foundation and can be used by any process type (investigations, implementations, reviews, etc.)..

## Parameters
- `stepName`: understand-context
- `stepCategory`: planning
- `stepPurpose`: Fully understand the context, sources, and requirements for a task or process. Clarify what needs to be accomplished, identify relevant information sources, understand success criteria, and document any specific requirements or constraints. Gather all necessary context to proceed with the work.
- `useCases`: When you need to understand the context, sources, and requirements for a task or process before proceeding with the work. This step is used at the beginning of processes to establish a clear foundation and can be used by any process type (investigations, implementations, reviews, etc.).
- `exampleContext`: 

## Context
- `repository`: agentic-processes
- `stepsDirectory`: core/processes/steps/
- `stepCategoryDirectory`: core/processes/steps/planning/
- `stepFile`: core/processes/steps/planning/understand-context.md
- `stepTemplate`: core/processes/steps/step-template.md
- `stepsReadme`: core/processes/steps/README.md
...
- [x] Step 3: Validate step structure
...
- [ ] Step 4: Continuous Improvement & Learning
  ...
  - **Context**:
    - `processLogPath`: core/processes/active/process-create-understand-context-step-20260103/log.md
    - `processName`: Create understand-context Step
