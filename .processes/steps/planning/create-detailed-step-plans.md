...
- This step assumes all required process-steps already exist in the `.processes/steps/` library
...
**Reference:** `.processes/steps/api/implement-controller-layer.md`
```
...
**Reference:** `.processes/steps/service/implement-service-layer.md`
```
...
**Reference:** `.processes/steps/data/implement-repository-layer.md`
```

### Validation

When creating detailed plans, verify that:
1. The referenced process-step exists in `.processes/steps/{category}/{step-name}.md`
...
**Reference:** `.processes/steps/category/step-name.md`
