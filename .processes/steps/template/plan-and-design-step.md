...
- Check existing steps in `.processes/steps/` for similar patterns
- Review `.processes/steps/README.md` for category guidelines
...
- Plan the step structure following `.processes/steps/step-template.md`
...
**Files/Folders:**
- Review: `.processes/steps/` for existing steps and patterns
- Review: `.processes/steps/README.md` for guidelines and category information
