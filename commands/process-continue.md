...
description: Continue an existing process from where it left off.
---
...
- **step-executor**: Use `Task` tool and provide the full content of `agents/step-executor.md` as the prompt, along with operating principles, step JSON, process context, and scope boundary.
- **process-spawner**: Use `Task` tool and provide the full content of `agents/process-spawner.md` as the prompt, along with template path, parameters, and parent context.
